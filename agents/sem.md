...
When merging parallel worktree results back to main: **merge in dependency order, one at a time, running integration tests after each merge.** Do not batch cherry-picks.
