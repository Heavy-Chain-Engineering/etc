...
uv run pytest    # 770+ contract tests, ~10 seconds
```
...
| `tests/` | Contract tests. ~770. Pytest, ~10 seconds. |
...
| `.etc_sdlc/features/F<NNN>-<slug>/` | Per-feature work directories. In client repos these are typically gitignored; in this repo they are committed as the harness's own audit trail. |
